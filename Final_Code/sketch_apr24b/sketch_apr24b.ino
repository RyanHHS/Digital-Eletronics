...
//#define redpin 9                                                 //pwm output for RED anode use 1K resistor
...
void loop() {
  ...
  analogWrite(red_light_pin, gammatable[(int)r]);                          //light red led as per calculation
  analogWrite(green_light_pin, gammatable[(int)g]);                        //light green led as per calculation
  analogWrite(blue_light_pin, gammatable[(int)b]);                         //light blue led as per calculation
}
